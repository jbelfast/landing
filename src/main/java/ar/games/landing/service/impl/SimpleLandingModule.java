...
public class SimpleLandingModule implements LandingModule, Runnable {
	...
	private LandingModuleConfiguration config;

	public SimpleLandingModule(LandingModuleConfiguration config) {
		this.config = config;
	}
